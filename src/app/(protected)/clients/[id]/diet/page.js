  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded border bg-white p-4">
        <DietEditor client={client} clientId={String(client._id)} />
      </div>
    </div>
  );
}

// dynamic import client component (must be client)
import dynamic from "next/dynamic";
const DietEditor = dynamic(() => import("@/components/DietEditor"), { ssr: false });
